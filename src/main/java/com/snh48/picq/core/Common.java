...
public class Common {
	...
	public static final String COMMAND_CAPTION_FIND_TRIP = "findTrip(findt/查看行程) | [北京/上海/广州/冷餐/公演/生日] [冷餐/公演/生日] | 根据北上广/行程类型查看行程，无参数默认查看全团所有行程，两个参数时默认参数1为北上广，参数2为类型。";
